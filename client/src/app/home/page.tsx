  ...
  const handleLogout = () => {
    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:flex space-x-8">
                <Link href="/home" className="font-medium text-gray-700 hover:text-blue-600 transition-colors duration-200 border-b-2 border-transparent hover:border-blue-600 pb-1">Dashboard</Link>
                <Link href="/lend" className="font-medium text-gray-700 hover:text-blue-600 transition-colors duration-200 border-b-2 border-transparent hover:border-blue-600 pb-1">Lend Money</Link>
                <Link href="/loans" className="font-medium text-gray-700 hover:text-blue-600 transition-colors duration-200 border-b-2 border-transparent hover:border-blue-600 pb-1">All Loans</Link>
              </nav>
            </div>
            <div className="flex items-center space-x-6">
              ...
              <div className="relative">                <button 
                ...
                >{profilePic ? (
                  ...
                  </div>                  <svg xmlns="http://www.w3.org/2000/svg" className={`h-3 w-3 text-gray-500 transition-transform duration-200 ${showProfileDropdown ? 'transform rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {showProfileDropdown && (
                  ...
                  >
                    <div className="py-2 border-b border-gray-100">
                      <p className="px-4 py-1 text-xs font-medium text-gray-500">ACCOUNT</p>
                    </div>
                    <Link href="/profile" className="flex items-center px-4 py-3 hover:bg-blue-50 transition-colors duration-150">
                    ...
                    >
                      ...
                      <span className="font-medium text-sm text-red-600">Logout</span>
                    </button>
                  </div>
                )}
              </div>
      ...
      <div className="container mx-auto px-6 py-10">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-800 mb-2 text-center">Your Lending Dashboard</h2>
          <p className="text-gray-600 text-center max-w-2xl mx-auto">
            Track your loans, manage payments, and monitor upcoming deadlines all in one place.
          </p>
        </div>
